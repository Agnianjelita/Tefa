<template>
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="text-center my-4">PENCARIAN BUKU</h2>
                <div class="my-3">
                    <input type="search" class="form-control rounded-5" placeholder="Masukan judul">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="card mb-3">
                            <div class="card-body">
                                <img src="~/assets/cover2.jpg" class="cover" alt="cover 2">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="card mb-3">
                            <div class="card-body">
                                <img src="~/assets/cover3.jpeg" class="cover" alt="cover 3">
                            </div>
                        </div>
                    </div>
                </div>
